...
public class EssaiCatmikaze extends Test{
	...
	public static void main(String[] args) {
		 ...
		 */
			...
			System.out.println("Degats Tir Recus: "+affichageTest(c.getDegatTir()==50));
		
			System.out.println("Degats Mine Recus : "+affichageTest(c.getDegatMine()==50));

			System.out.println("Type : "+affichageTest(c.getType()=="Catmikaze"));
		 ...
		 */
			...
			System.out.println("Deplacement impossible 1 : "+affichageTest(!c.deplacer(-1, -2)));
			
			System.out.println("Deplacement impossible 2 : "+affichageTest(!c.deplacer(0, 5)));
		
			System.out.println("Deplacement impossible 3 : "+affichageTest(!c.deplacer(2, 3)));
		 ...
		 */
			...
			System.out.println("Tir Impossible 2 : "+affichageTest(!c.peutTirer(5, 3)));
		...
		/*
		 * affichage en % de la reussite des tests
		 * 
		 */
