...
public class EssaiTireur extends Test{
	...
	public static void main(String[] args) {
		 ...
		 */
			...
			System.out.println("Cout Deplacement : "+affichageTest(c.getCoutDep()==1));

			System.out.println("Degats Tir Recus: "+affichageTest(c.getDegatTir()==3));
		
			System.out.println("Degats Mine Recus : "+affichageTest(c.getDegatMine()==10));

			System.out.println("Type : "+affichageTest(c.getType()=="Tireur"));
	
			System.out.println("Energie Max : "+affichageTest(c.getEnergieMax()==40));
					
			System.out.println("Energie : "+affichageTest(c.getEnergie()==40));
		 ...
		 */
			...
			System.out.println("Deplacement impossible 2 : "+affichageTest(!c.deplacer(1,5)));
		
			System.out.println("Deplacement impossible 3 : "+affichageTest(!c.deplacer(2, 5)));
			
			System.out.println("Deplacement Possible : "+affichageTest(c.deplacer(1, 3)));
		 ...
		 */
			...
			System.out.println("Tir Possible : "+affichageTest(c.peutTirer(0, 6)));
		
			System.out.println("Tir Impossible 1 : "+affichageTest(!c.peutTirer(0,7)));
