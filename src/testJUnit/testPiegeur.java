...
public class testPiegeur{
	...
	public void test_Modif_Get_Set(){
		Assert.assertEquals(Piegeur.getDeplacement(),1);
		Assert.assertEquals(Piegeur.getCoutAction(),2);
		Assert.assertEquals(c.getCoutDep(),2);
		Assert.assertEquals(c.getDegatTir(),2);
		Assert.assertEquals(c.getDegatMine(),2);
		Assert.assertEquals(c.getType(),"Piegeur");
	...
	public void test_Deplacements(){
		...
		Assert.assertFalse(c.deplacer(3, 5));
		Assert.assertFalse(c.deplacer(2, 5));
		Assert.assertTrue(c.deplacer(0, 4));
	...
	public void test_Tirs_Possibles(){
		...
		Assert.assertTrue(c.peutTirer(1, 4));
